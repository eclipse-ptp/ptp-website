<?php  																														require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/app.class.php");	require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/nav.class.php"); 	require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/menu.class.php"); 	$App 	= new App();	$Nav	= new Nav();	$Menu 	= new Menu();		include($App->getProjectCommon());    # All on the same line to unclutter the user's desktop'
	...
	<div id="midcolumn">
		...
		<p>The latest release of PTP is <b><font size=+1>6.0.0</font></b>, released June 27, 2012 which works with <b>Eclipse Juno (4.2)</b>.
		</p>
    <p>Please see the <font size=+1><a href="http://wiki.eclipse.org/PTP/release_notes/6.0">
      ...
      <a href="http://download.eclipse.org/tools/ptp/updates/juno">http://download.eclipse.org/tools/ptp/updates/juno</a>. <b>Currently has PTP 6.0.0</b>
      </ul>  
      See the <a href="http://wiki.eclipse.org/PTP/release_notes/6.0">release notes</a> for more details.
      </ol>
</p>
<p>Currently, as of PTP Release 6.0.0 and Eclipse Juno (27 June 2012), the <b>Eclipse for Parallel Application Developers</b>
<!-- also -->
contains PTP 6.0.0, 
<!-- so if you have that installed you may wish to update to 6.0.1 via the PTP-specific update site listed above. -->
so if you install that, <!--or update a previous <b>Eclipse for Parallel Application Developers</b>, --> everything will be up to date. 
<p>
...
<p>Archived update site (You asked for it!) can be downloaded from:
  ...
  <ul>     
  <li><a href="http://www.eclipse.org/downloads/download.php?file=/tools/ptp/updates/indigo/ptp-proxy-6.0.0.zip">ptp-proxy-6.0.0.zip</a>
  </ul>
</div>
  ...
  <tr>
    <td align=left valign=top >
        <tr bgcolor="#CCCCCC">
         ...
         <tr>
          <td>AIX</td>
          <td><div align="left">6.0.0</div></td>
          <td><div align="left"><a href="http://www.eclipse.org/downloads/download.php?file=/tools/ptp/updates/indigo/rdt-server-aix-6.0.0.tar">rdt-server-aix-6.0.0.tar</a></div></td>
        </tr>
        <tr>
          <td>Linux (Generic)</td>
          <td><div align="left">6.0.0</div></td>
          <td><div align="left"><a href="http://www.eclipse.org/downloads/download.php?file=/tools/ptp/updates/indigo/rdt-server-linux-6.0.0.tar">rdt-server-linux-6.0.0.tar</a></div></td>
        </tr>
        <tr>
          <td>Linux (PPC)</td>
          <td><div align="left">6.0.0</div></td>
          <td><div align="left"><a href="http://www.eclipse.org/downloads/download.php?file=/tools/ptp/updates/indigo/rdt-server-linux.ppc-6.0.0.tar">rdt-server-linux.ppc-6.0.0.tar</a></div></td>
        </tr>
        <tr>
          <td>Linux (x86)</td>
          <td><div align="left">6.0.0</div></td>
          <td><div align="left"><a href="http://www.eclipse.org/downloads/download.php?file=/tools/ptp/updates/indigo/rdt-server-linux.x86-6.0.0.tar">rdt-server-linux.x86-6.0.0.tar</a></div></td>
        </tr>
        <tr>
          <td>Unix</td>
          <td><div align="left">6.0.0</div></td>
          <td><div align="left"><a href="http://www.eclipse.org/downloads/download.php?file=/tools/ptp/updates/indigo/rdt-server-unix-6.0.0.tar">rdt-server-unix-6.0.0.tar</a></div></td>
        </tr>
		<tr>
          <td>MacOS X</td>
          <td><div align="left">6.0.0</div></td>
          <td><div align="left"><a href="http://www.eclipse.org/downloads/download.php?file=/tools/ptp/updates/indigo/rdt-server-macosx-6.0.0.tar">rdt-server-macosx-6.0.0.tar</a></div></td>
        </tr>
		<tr>
          <td>Windows</td>
          <td><div align="left">6.0.0</div></td>
          <td><div align="left"><a href="http://www.eclipse.org/downloads/download.php?file=/tools/ptp/updates/indigo/rdt-server-windows-6.0.0.zip">rdt-server-windows-6.0.0.zip</a></div></td>
        </tr>
